...
ensemble_configuration = {
    ...
    # NetCDF file containing EXPANDED ERA5 ensemble on single levels
    'expanded era5 single lvl file name': 'example_data/era5_expanded_ens_single_lvl_2026-09-01_00UTC.nc',
